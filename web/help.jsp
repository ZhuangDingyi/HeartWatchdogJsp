    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="help.jsp"><i class="glyphicon glyphicon-list-alt"></i>  使用指南</a></li>
            </ul>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row clearfix">
                <div class="col-md-3 column">
                    <img height=200px src="images/help/zhishi01.png ">
                </div>
                <div class="col-md-9 column">
                    <p>1、擦拭皮肤</p>
                    <p>用湿毛巾或者湿巾擦拭手腕，保持电极接触处皮肤湿润，以使测量效果最佳。</p>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-md-3 column">
                    <img src="images/help/zhishi02.png" height=200px>
                </div>
                <div class="col-md-9 column">
                    <p>2、双手平放</p>
                    <p>坐姿平稳，双手平放大腿之上</p>
            ...
            <div class="row clearfix">
                <div class="col-md-3 column">
                    <img src="images/help/shouchi.png" height=300px >
                </div>
                <div class="col-md-9 column">
                    <p>3、开始检测</p>
                    <p>使用心狗?测量心律时应该保持好坐姿，连好硬件后，待波形稳定后，点击“开始”进行测量。</p>
                </div>
            </div>
            <h2>测量步骤：</h2>
            <p>按照图示连接手机和心狗硬件</p>
            <p>单手持握手机，待波形稳定后点击“开始”进行测量；</p>
            <p>测量结束后，在“趋势”页面查看数据趋势和历史数据，“医疗”页面查看所检测出的对应疾病的相关解释以及治疗方法，在“设置”页面可以进行用户密码更改。</p>
            <br>
        </div>
    </div>
    <div class="row">
